...
const ClientList = () => {
  ...
  return (
    <div className="p-2 bg-white border rounded-xl min-h-screen h-auto relative">
      ...
      <table className="min-w-full bg-white rounded-lg border border-collapse border-gray-300">
        <thead>
          <tr className="text-gray-500 m-2">
            <th className="border-t border-b border-gray-300 p-4 rounded-tl-lg mx-2">Name</th>
            <th className="border-t border-b border-gray-300 p-4 mx-2">Email</th>
            <th className="border-t border-b border-gray-300 p-4 mx-2">Phone Number</th>
            <th className="border-t border-b border-gray-300 p-4 mx-2">Creation Date</th>
            <th className="border-t border-b border-gray-300 p-4 rounded-tr-lg mx-2">State</th>
          </tr>
        </thead>
        <tbody>
